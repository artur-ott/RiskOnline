   ...
   def updateAttackerDices() {
    ...
    for (i <- 0 to diceStatus._1.length-1) {
      diceStatus._1(i) match {
        case 1 => diceLabelListA(i).setIcon(new ImageIcon(dice1_img)); diceLabelListA(i).setVisible(true)
        case 2 => diceLabelListA(i).setIcon(new ImageIcon(dice2_img)); diceLabelListA(i).setVisible(true)
        case 3 => diceLabelListA(i).setIcon(new ImageIcon(dice3_img)); diceLabelListA(i).setVisible(true)
        case 4 => diceLabelListA(i).setIcon(new ImageIcon(dice4_img)); diceLabelListA(i).setVisible(true)
        case 5 => diceLabelListA(i).setIcon(new ImageIcon(dice5_img)); diceLabelListA(i).setVisible(true)
        case 6 => diceLabelListA(i).setIcon(new ImageIcon(dice6_img)); diceLabelListA(i).setVisible(true)
        case _ => 
      }    
    }
  ...
  def updateDefenderDices() {
    ...
    for (j <- 0 to diceStatus._2.length-1) {
      diceStatus._2(j) match {
        case 1 => diceLabelListB(j).setIcon(new ImageIcon(dice1_img)); diceLabelListB(j).setVisible(true)
        case 2 => diceLabelListB(j).setIcon(new ImageIcon(dice2_img)); diceLabelListB(j).setVisible(true)
        case 3 => diceLabelListB(j).setIcon(new ImageIcon(dice3_img)); diceLabelListB(j).setVisible(true)
        case 4 => diceLabelListB(j).setIcon(new ImageIcon(dice4_img)); diceLabelListB(j).setVisible(true)
        case 5 => diceLabelListB(j).setIcon(new ImageIcon(dice5_img)); diceLabelListB(j).setVisible(true)
        case 6 => diceLabelListB(j).setIcon(new ImageIcon(dice6_img)); diceLabelListB(j).setVisible(true)
        case _ => 
      }    
    }
